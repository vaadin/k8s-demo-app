...
import com.vaadin.k8s.views.helloworld.HelloWorldView;
import com.vaadin.k8s.views.personas.PersonasView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2( "k8s-demo-app");
    ...
    private List<RouterLink> createLinks() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("About", "la la-gem", AboutView.class), //

                new MenuItemInfo("Personas", "la la-people-carry", PersonasView.class), //
